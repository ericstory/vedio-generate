...
| `cleanup_runpod.py [--yes]` | Handoff step 8: delete the residual serverless endpoints and the volumes nothing mounts. Dry run without `--yes`; refuses to touch the LTX production endpoint/volume or the Wan Pod lane volumes. |
